...
<<<<<<< HEAD
        const imageUrl = Utils.resolveMediaUrl(data.image_url);
        const topPredictions = data.raw_ml_response?.top_predictions || [];
=======
>>>>>>> e6e80e1585eab5abf6fb939fd61354d35f8bd21e
...
<<<<<<< HEAD
                            ${imageUrl ? `
                                <img src="${imageUrl}" alt="Diagnosis upload" class="img-fluid rounded-3 shadow-sm">
=======
                            ${data.image_url ? `
...
<<<<<<< HEAD
                    ...
                    <div class="result-section">
                        <h3 class="result-section-title">
                            <i class="bi bi-list-stars"></i> Top Model Predictions
                        </h3>
                        ${topPredictions.map(prediction => `
                            <div class="d-flex justify-content-between border-bottom py-2">
                                <span>${prediction.disease}</span>
                                <strong>${(Number(prediction.confidence || 0) * 100).toFixed(1)}%</strong>
                            </div>
                        `).join('')}
                    </div>
                    ` : ''}
