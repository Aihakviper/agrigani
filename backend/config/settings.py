"""
Django settings for AgriGani Core project.
"""
...
INSTALLED_APPS = [
    ...
    # Local apps
     'agrigani_core.core.apps.CoreConfig',      # NOT just 'core'
    'agrigani_core.api.apps.ApiConfig', 
]
...
DATABASES = {
    ...
    #     'NAME': os.getenv('DB_NAME', 'agrigani_db'),
...
OBJECT_STORAGE_BUCKET = os.getenv('OBJECT_STORAGE_BUCKET', 'agrigani-images')

# FastAPI ML Service Configuration
FASTAPI_ML_SERVICE_URL = os.getenv('FASTAPI_ML_SERVICE_URL', 'http://localhost:8001')
ENABLE_MOCK_ML_FALLBACK = os.getenv('ENABLE_MOCK_ML_FALLBACK', 'False') == 'True'
